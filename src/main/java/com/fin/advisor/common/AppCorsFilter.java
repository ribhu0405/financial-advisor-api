...
@Override
    public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain)
        ...
        response.setHeader("Access-Control-Allow-Headers","Authorization,Content-Type,cache-control,Ocp-Apim-Trace,Ocp-Apim-Subscription-Key,Origin,clientId,apiKey,pragma");
